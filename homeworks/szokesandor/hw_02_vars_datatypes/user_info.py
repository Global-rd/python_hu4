...
Zsonglőrködés list és dictionary adattípusokkal
...
prog_languages = input("Enter four programming languages separated by a comma! ").split(",")
...
user_info["phone_contacts"]["Donald Duck"] = "+36209285605"
...
user_info["phone_contacts"]["Yogi Bear"] = ["+36201114567", "+36307774321"]


# Extra 1: Printeld ki a "skills" lista utolsó 3 elemét ellentétes sorrendben!

print("----")
print(f"Utolsó 3 elem ellentétes sorrendben: {user_info["skills"][-1:-4:-1]}")
...
# user_info végső, teljes tartalma
