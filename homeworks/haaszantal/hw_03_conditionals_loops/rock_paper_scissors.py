...
#for _ in range(requested_round_number): -- ehelyett legyen egy while ciklus
while current_round <= requested_round_number:
      
      #minden körön belül elvégzek ellenőrzéseket, illetve megállapítok győztest
      #while True: -- erre nincs szükség
            ...
            #Szétválasztom a 2 átékos esetében a szavak érvényességének vizsgálatát.

        #megvizsgálom a szó érvényességét az első játékos esetében. Érvénytelen szó esetén újra bekérés.
        while True:
                    answer_player1 = input("Az első játékos válasza (kő, papír, olló): ").lower().strip()
                    if answer_player1 not in ["kő", "papír", "olló"]:
                        print("Érvénytelen szó! Újra!")
                        continue
                    break
                    

        #megvizsgálom a szó érvényességét a második játékos esetében. Érvénytelen szó esetén újra bekéré.
        while True:
                    answer_player2 = input("A második játékos válasza (kő, papír, olló): ").lower().strip()
                    if answer_player2 not in ["kő", "papír", "olló"]:
                        print("Érvénytelen szó! Újra!")
                        continue
                    break
        ...
        if answer_player1 == answer_player2:
            ...
            #A 3 elif-et így egybe lehet tenni
        elif (answer_player1 == "kő" and answer_player2 =="olló" or
                  answer_player1 == "olló" and answer_player2 =="papír" or
